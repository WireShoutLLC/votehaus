				...
				<div class="box">
					...
					<div class="box-body">
						<div class="alert alert-info">
							...
							This election uses the <a href="https://www.youtube.com/watch?v=3Y3jE3B8HsE&t=2s">alternative vote</a> method. To vote, drag the names of the candidates you would like to vote for ABOVE the --ORDER ABOVE HERE-- line, then order your chosen candidates from top to bottom by preferance, with the top being your favorite candidate and the bottom your least. If you do not want to vote for a candidate, leave them below the --ORDER ABOVE HERE-- line.
						</div>
						<ul id="candidates" class="list-group">
							<li class="list-group-item">--ORDER ABOVE HERE--</li>
							<?php foreach($election_nominees as $nominee) { 
							$voter_guide = json_decode($nominee['data'], true)['voter_guide']; ?>
							<li class="list-group-item" id="<?php echo $nominee['user']; ?>"><?php echo $voter_guide[0]; ?></li>
							<?php } ?>
						</ul>
